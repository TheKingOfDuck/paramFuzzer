...
public class CompareStrSimUtil {
    ...
    public static float simCalc(String oldStr, String newStr) {
        CompareStrSimUtil lt = new CompareStrSimUtil();
        //System.out.println("similarityRatio=" + lt.getSimilarityRatio(oldStr, newStr, true));
        return lt.getSimilarityRatio(oldStr, newStr, true);
    }
